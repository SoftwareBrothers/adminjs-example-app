...
export class CryptoDatabase extends BaseResource {
  ...
  private readonly _properties: BaseProperty[] = [
    new BaseProperty({ path: 'website_slug', type: 'string', isId: true, isSortable: true, position: 1 }),
    new BaseProperty({ path: 'name', type: 'string', isSortable: false, position: 2 }),
    new BaseProperty({ path: 'symbol', type: 'string', isSortable: false, position: 3 }),
    new BaseProperty({ path: 'quotes.USD.price', type: 'string', isSortable: false, position: 4 }),
    new BaseProperty({ path: 'quotes.USD.percent_change_1h', type: 'string', isSortable: false, position: 5 }),
    new BaseProperty({ path: 'quotes.USD.percent_change_24h', type: 'string', isSortable: false, position: 6 }),
    new BaseProperty({ path: 'quotes.USD.percent_change_7d', type: 'string', isSortable: false, position: 7 }),
    new BaseProperty({ path: 'last_updated', type: 'date', isSortable: false, position: 8 }),
  ];
