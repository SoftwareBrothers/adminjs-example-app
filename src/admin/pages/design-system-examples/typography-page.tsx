    ...
    <Box variant="grey">
      ...
      <Box variant="white">
        ...
        <Text>
          ...
          rutrum leo. Donec malesuada quis metus vel pulvinar. Quisque in vehicula nulla. Nam vestibulum facilisis
          lorem, ac mattis odio aliquet et. Suspendisse enim ligula, ultricies pellentesque ligula id, molestie sodales
          quam. Etiam in lectus ut nibh laoreet consequat.
        </Text>
        <Header />
        <Text variant="sm">
          ...
          elementum augue et bibendum molestie. Duis tincidunt pellentesque enim ac mattis. Nunc congue, ante id
          efficitur gravida, turpis velit porta nunc, at egestas urna odio eget arcu. Ut enim metus, fringilla eu risus
          eu, sodales venenatis lacus.
        </Text>
        <Header />
        <Text variant="xs">
          ...
          cubilia curae; Suspendisse aliquet suscipit turpis at placerat. Cras quis sem vitae velit vehicula congue et
          nec libero. Curabitur aliquam, est id dapibus egestas, felis augue suscipit est, eu venenatis leo justo vel
          sapien. Donec id dignissim diam. Nulla feugiat ex sit amet augue sollicitudin pulvinar. Pellentesque id felis
          rhoncus, varius sem et, condimentum ligula. Proin accumsan sit amet nisl ac vehicula. Nulla facilisi. Ut
          pharetra vel tortor vel lacinia. Nulla sit amet neque lectus. Mauris tristique justo in sem tempus, at
          sagittis lectus molestie. Phasellus sit amet nulla id mi rutrum varius in eu nisi.
        </Text>
      </Box>
    </Box>
  );
